...
Run experiments by varying "beta^4 * gamma" while keeping constant beta^2.
...
if __name__ == "__main__":
    ...
    plt.grid(True)
    visuals.setspines()
    plt.savefig(EXPERIMENT_DIR+f'/varying_beta_loglog_energies_{info_experiment}.png', dpi=300)
